...
public class MysqlExport {
	...
	public void export() throws IOException, SQLException, ClassNotFoundException {
		...
		connection = MysqlUtil.connectWithURL(this.mySqlInfo.getUser(), this.mySqlInfo.getPassword(),
				this.mySqlInfo.getJdbcUrl(), driverName);
	...
	public void clearTempFiles(boolean preserveZipFile) {
		...
		if (sqlFile.exists()) {
			...
			System.out.println(
					": " + sqlFile.getAbsolutePath() + " deleted successfully? " + (res ? " TRUE " : " FALSE "));
		} else {
		...
		if (sqlFolder.exists()) {
			...
			System.out.println(
					": " + sqlFolder.getAbsolutePath() + " deleted successfully? " + (res ? " TRUE " : " FALSE "));
		} else {
		...
		if (!preserveZipFile) {
			...
			if (folder.exists()) {
				...
				System.out.println(
						": " + folder.getAbsolutePath() + " deleted successfully? " + (res ? " TRUE " : " FALSE "));
			} else {
